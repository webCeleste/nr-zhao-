<template>
  <div class="independent">
    <el-dialog
      class="independent"
      :visible.sync="$store.state.Lightpath"
      width="30%"
    ...
    >
      <div class="headerbox">
        <div class="leftheader">
          <img src="../../assets/img/光路切图/光路icon.png" alt />
          <div class="headertitle">光路</div>
        </div>
      ...
      <div class="tabsbox">
        <div class="tabslistbox">
          <div
            :class="cur == index ? 'switchbutton' :'switchbuttonnone'"
            v-for="(item,index) in tabslist"
            :key="index"
            @click="tabschage(index)"
          >{{item}}</div>
        </div>
        ...
        <div v-show="heightchage">
          <div class="tablemain" v-if="cur ==0">
            <div class="leftone">
              <div
                class="tableleftkey"
                v-for="(item,index) in information.tabletopkey"
                :key="index"
              >{{item}}</div>
            </div>
            <div class="lefttwo">
              <div
                class="tableleftvalue"
                v-for="(item,index) in information.tabletop"
                :key="index"
              >{{item}}</div>
            </div>
            <div class="leftone">
              <div
                class="tableleftkey"
                v-for="(item,index) in information.tabletopkey2"
                :key="index"
              >{{item}}</div>
            </div>
            <div class="leftthree">
              <div
                class="tableleftvalue2"
                v-for="(item,index) in information.tabletop2"
                :key="index"
              >{{item}}</div>
            </div>
          </div>
          ...
          <div class="tablemain" v-if="cur ==1">
            <el-table :data="serviceData" style="width: 100%" height="227" key="serviceData">
              ...
              ></el-table-column>
              <el-table-column
                prop="detailedBusinessType"
                label="详细业务类型"
                width="140"
                show-overflow-tooltip
                sortable
              ></el-table-column>
              <el-table-column prop="APlat" label="A站点" width="240" show-overflow-tooltip sortable></el-table-column>
              <el-table-column prop="ZPlat" label="Z站点" width="240" show-overflow-tooltip sortable></el-table-column>
              <el-table-column
                prop="interfaceType"
                label="接口类型"
                width="100"
          ...
          <div class="tablemain" v-if="cur ==2">
            <el-table :data="passageway" style="width: 100%" height="227" key="passageway">
              <el-table-column prop="name" label="名称" width="480" show-overflow-tooltip sortable>
                <template slot-scope="scope">
              ...
              <el-table-column
                ...
                sortable
              ></el-table-column>
              <el-table-column prop="remarks" label="备注" width="180" show-overflow-tooltip sortable></el-table-column>
            </el-table>
          </div>
        </div>
      </el-collapse-transition>
  ...
  data() {
    return {
      ...
      passageway: [
        ...
        {
          name:
            "E_2M[桃乡I:2框-11槽-1端口-时隙：1 尖山变：1框-11槽-3端口-时隙：1]",
          runningstate: "在役",
          channeltype: "SDH通道",
          rate: "2.5G",
          asite: "500kV桃乡变",
    ...
    .el-dialog__body {
      ...
      .mainbox {
        ...
        .mainleftside {
          ...
          height: 100%;
          position: relative;
          background: url("../../assets/img/components-dialog/dialogbj2.png")
            no-repeat center;
        ...
        .links {
          width: 2px;
          height: 100%;
          background: url("../../assets/img/components-dialog/links1.png")
            no-repeat center;
