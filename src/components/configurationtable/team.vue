    ...
    >
      ...
      >
        <el-form-item label="值班单位" prop="name">
          <el-select v-model="ruleForm.name" placeholder="请选择所属公司" :disabled="code == 1" style="width:100%">
        ...
        <el-form-item label="班组名称" prop="company">
    ...
    submitForm(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid && this.code == 0) {
          ...
          this.$emit("ruleFormteam", params);
          this.$emit("update:tablebooleteam", false);
          //   this.resetForm(formName);
        } else if (valid && this.code == 1) {
          console.log(this.ruleForm, this.code, ">>>>>");
          this.$emit("ruleFormteam", this.ruleForm);
          this.resetForm(formName);
          this.$emit("update:tablebooleteam", false);
        }
      });
