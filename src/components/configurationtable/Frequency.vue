<template>
  <div>
    <el-dialog
      :visible.sync="tableboolefrequency"
      width="500px"
      ...
      >
        ...
        <el-form-item label="班次名称" prop="company">
          <el-input v-model="ruleForm.company" @focus="companyvalue"></el-input>
        </el-form-item>
        <el-form-item label="班次开始时间" prop="date">
          <el-time-picker
        ...
        <el-form-item label="班次结束时间" prop="date1">
          <el-time-picker
        ...
        <el-form-item label="跨日" prop="span">
    ...
    submitForm(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid && this.code == 0) {
          ...
          this.$emit("ruleFormfrequency", params);
          this.$emit("update:tableboolefrequency", false);
          //   this.resetForm(formName);
        } else if (valid && this.code == 1) {
          console.log(this.ruleForm, this.code, ">>>>>");
          this.ruleForm.span = this.ruleForm.span == true ? "是" : "否";
          this.$emit("ruleFormfrequency", this.ruleForm);
          this.resetForm(formName);
          this.$emit("update:tableboolefrequency", false);
        }
      });
